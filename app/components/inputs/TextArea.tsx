    ...
    return (
        <div className="w-full relative">
            ...
            <label
                ...
                peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4 ${errors[id] ? 'focus:border-rose-400' : 'focus:border-slate-300'}`}
            >
                {label}
            </label>
        </div>
